...
public class TGPacketPipeline extends MessageToMessageCodec<FMLProxyPacket, AbstractPacket>
{
	...
	public boolean registerPacket(Class<? extends AbstractPacket> clazz)
	{
		...
		{
			TravellersGear.logger.log(Level.ERROR, "Can't register Packet: Size of PacketList is too big!");
			return false;
		}
		if (this.packets.contains(clazz))
		{
			TravellersGear.logger.log(Level.ERROR, "Can't register Packet: Packet registered already!");
			return false;
		}
		if (this.isPostInitialised)
		{
			TravellersGear.logger.log(Level.ERROR, "Can't register Packet: Pipeline is already post-initialized!");
			return false;
		}
